...

{
  ...
  services.udev.extraRules =
    let
      activatePowerSaver = pkgs.writeShellScript "power-save" "powerprofilesctl set power-saver";
      activatePerformance = pkgs.writeShellScript "performance" "powerprofilesctl set performance";
    in
    ''
