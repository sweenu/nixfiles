...
- carokann: my personal computer ([Framework](https://frame.work) laptop).
- benoni: my server ([Scaleway](https://scaleway.com) DEV1-M) where I deploy my self-hosted apps.
- grunfeld: my main RaspberryPi that serves as a [snapcast](https://github.com/badaix/snapcast) server and a local backup.
...
- Wayland bar: [Waybar](https://github.com/Alexays/Waybar) (style copied from [this reddit post](https://www.reddit.com/r/unixporn/comments/lepmss/sway_simple_sway_on_nixos/))
